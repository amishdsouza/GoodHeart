...
<body>
    ...
    <section class="shop-body pt-85 mb-90 gray-border-top">
        <div class="has-breadcrumb-content">
            <div class="breadcrumb-content d-flex justify-content-center align-items-center" style="flex-direction: column;">
             ...
             <nav aria-label="breadcrumb">
                 <ol class="breadcrumb w-r-80 p-0 m-0">
                     <li class="breadcrumb-item"><a href="index5.html">Home</a></li>
                     <li class="breadcrumb-item" aria-current="page"><a href="portfolio.html">Portfolio</a></li>
                     <li class="breadcrumb-item active" aria-current="page">LANDER – LED Aluminium Outdoor Wall Lamp</li>
                 </ol>
             </nav>
            </div>
         </div>
        <div class="container-fluid">
            <div class="portfolio-body mt-95">
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        <div class="portfolio-left">
                            <div class="portfolio-img">
                                <img src="img/portfolio/5.jpg" class="w-100" alt="">
                                <div class="small-img mt-10 small-img-carousel owl-carousel">
                                    <a class="popup-image" href="img/portfolio/1-big.jpg"><img src="img/portfolio/1.jpg" width="150" height="150" alt=""></a>
                                    <a class="popup-image" href="img/portfolio/2-big.jpg"><img src="img/portfolio/2.jpg" width="150" height="150" alt=""></a>
                                    <a class="popup-image" href="img/portfolio/3-big.jpg"><img src="img/portfolio/3.jpg" width="150" height="150" alt=""></a>
                                    <a class="popup-image" href="img/portfolio/4-big.jpg"><img src="img/portfolio/4.jpg" width="150" height="150" alt=""></a>
                                    <a class="popup-image" href="img/portfolio/5.jpg"><img src="img/portfolio/5.jpg" width="150" height="150" alt=""></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        <div class="portfolio-right">
                            <h2 class="title">LANDER – LED aluminium Outdoor wall Lamp</h2>
                            <p>Duis vestibulum porttitor rutrum. Donec euismod nunc vitae felis porta rhoncus. Pellentesque quis bibendum lorem. Mauris auctor id mi efficitur fringilla. Sed ante nisi, hendrerit tincidunt facilisis et, volutpat non nulla. Nulla facilisis aliquam porttitor. Proin tempus justo lorem</p>
                            <div class="portfolio-desc-list">
                                <ul>
                                    <li>
                                        <h6>Date</h6>
                                        <p><span class="date-count">15</span> / Feb</p>
                                    </li>
                                    <li>
                                        <h6>Categories</h6>
                                        <p>fashion, men</p>
                                    ...
                                    <li>
                                        <h6>Client</h6>
                                        <p>efficitur ut rutrum</p>
                                    </li>
                                    <li>
                                        <h6>Link</h6>
                                        <a href="shop.html">Visit project</a>
                                    </li>
                                    <li>
                                        <h6>Testimonial</h6>
                                        <p>efficitur ut rutrum</p>
                                    ...
                                    <li>
                                        <div class="portfolio-social">
                                            ...
                                            <a href="#" data-toggle="tooltip" data-placement="top" title="pinterest"><i class="fab fa-pinterest-p"></i></a>
                                            <a href="#" data-toggle="tooltip" data-placement="top" title="google +"><i class="fab fa-google-plus-g"></i></a>
                                            <a href="#" data-toggle="tooltip" data-placement="top" title="linkedin"><i class="fab fa-linkedin-in"></i></a>
                                        </div>
                                    </li>
                                    <li>
                                        <a href="javascript:void(0)"  data-toggle="tooltip" data-placement="top" title="Like this post"><i class="fal fa-heart"> <span>0</span></i></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
    ...
    <section class="related-product mt-120 pb-50">
        <div class="container-fluid">
    ...
    <section class="footer">
        <div class="footer-top pb-120 pt-115" style="background-color: #f5f5f5;">
