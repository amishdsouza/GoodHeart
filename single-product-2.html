        ...
        <div class="container-fluid">
            <nav aria-label="breadcrumb" class="mb-40">
                <ol class="breadcrumb p-0 m-0">
                    ...
                    <li class="breadcrumb-item" aria-current="page"><a href="single-product-3.html">Product</a></li>
            ...
            <div class="shop-wrapper">
                <div class="single-product-top">
                    <div class="row justify-content-center">
                        <div class="col-12">
                            <div class="shop-img">
                                <div class="product-3-carousel owl-carousel red-nav">
                                    <a href="img/product/farniture-1.jpg" class="popup-image"><img src="img/product/farniture-1.jpg" class="w-100 mb-30" alt=""></a>
                                    <a href="img/product/farniture-2.jpg" class="popup-image"><img src="img/product/farniture-2.jpg" class="w-100 mb-30" alt=""></a>
                                    <a href="img/product/farniture-3.jpg" class="popup-image"><img src="img/product/farniture-3.jpg" class="w-100 mb-30" alt=""></a>
                                    <a href="img/product/farniture-4.jpg" class="popup-image"><img src="img/product/farniture-4.jpg" class="w-100 mb-30" alt=""></a>
                                    <a href="img/product/farniture-5.jpg" class="popup-image"><img src="img/product/farniture-5.jpg" class="w-100 mb-30" alt=""></a>
                                    <a href="img/product/farniture-6.jpg" class="popup-image"><img src="img/product/farniture-6.jpg" class="w-100" alt=""></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-8">
                            <div class="single-product-sidebar mt-120">
                                <div class="product-content text-center">
                                    <div class="single-product-title">
                                        <h2 class="mb-25-important">Elegant wooden leg design Replica</h2>
                                    </div>
                                    <div class="total-rating mb-10">
                                        <div class="rating d-inline-block mr-10">
                                            <i class="fal fa-star red-color"></i>
                                            <i class="fal fa-star red-color"></i>
                                            <i class="fal fa-star"></i>
                                            <i class="fal fa-star"></i>
                                            <i class="fal fa-star"></i>
                                        </div> (1 customar review)
                                    </div>
                                    <div class="single-product-price f-500 mb-15">$<span>44.00</span> <del style="color: #888;" class="f-400">$250.00</del></div>
                                    ...
                                    <div class="quick-quantity gray-border-top mt-45">
                                        <form action="#" method="POST">
                                            <div class="total-cart mt-30"><span class="cart-count">19 in stock (can be backordered)</span></div>
                                            <button type="submit" class="list-add-cart-btn red-hover-btn border-0" style="padding-left: 80px;padding-right: 80px;transition: all .5s;">add to
                                                cart
                                            </button>
                                        </form>
                                    </div>
                                    ...
                                    <div class="single-product-category">
                                        <ul>
                                            ...
                                            <li class="mb-0"><a href="shop2.html">Chair & Table</a></li>
                                            <li class="mb-0"><a href="shop2.html">Chairs</a></li>
                                            <li class="mb-0"><a href="shop2.html">Handbeg</a></li>
                                        </ul>
                                    </div>
                                    <div class="single-product-tags">
                                        <ul>
                                            <li><a href="javascript:void(0)" class="title">Tags: </a></li>
                                            <li><a href="shop.html">Accessories</a></li>
                                            <li><a href="shop2.html">Clothing</a></li>
                                            <li><a href="shop3.html">fashion</a></li>
                                            <li><a href="shop4.html">Fly</a></li>
                                    ...
                                    <table class="table table-striped">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <ul>
                                                        <li><a href="shop3.html">3XL</a></li>
                                                        <li><a href="shop3.html">L</a></li>
                                                        <li><a href="shop3.html">M</a></li>
                                                        <li><a href="shop3.html">S</a></li>
                                                        <li><a href="shop3.html">XL</a></li>
                                                        <li><a href="shop3.html">XXL</a></li>
                                                    </ul>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <ul>
                                                        <li><a href="shop3.html">Black</a></li>
                                                        <li><a href="shop3.html">Blue</a></li>
                                                        <li><a href="shop3.html">Gold</a></li>
                                                        <li><a href="shop3.html">Gray</a></li>
                                                        <li><a href="shop3.html">White</a></li>
                                                        <li><a href="shop3.html">Yellow</a></li>
                                                        <li><a href="shop3.html">Red</a></li>
                                                    </ul>
                                                </td>
                                            </tr>
                                        </tbody>
                        ...
                        <div class="product-box">
                            <div class="product-box-wrapper">
                                <div class="product-img">
                                    ...
                                    <a href="single-product-3.html" class="d-block"><div class="second-img">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-7 col-lg-7 col-md-7 col-sm-6">
                            <div class="product-content">
                                ...
                                <a href="shop2.html" class="all-feature">See all feature</a>
