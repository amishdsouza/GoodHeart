...
<body>
    ...
    <div class="shop-body mb-90">
        <div class="has-breadcrumb-bg mb-120"  data-background="img/bg/2.jpg">
            ...
            <div class="shop-wrapper">
                <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-5 col-md-5">
                                                <div class="blog-box-img">
                                                    <a href="single-blog-1.html"><img src="img/blog/1.jpg" class="w-100" alt=""></a>
                                                    <div class="blog-box-tags">
                                                        <a href="single-blog-1.html">Image</a>
                                            ...
                                            <div class="col-xl-7 col-md-7">
                                                <div class="blog-box-desc primary-desc">
                                                    ...
                                                    <a href="single-blog-1.html" class="blog-box-action pt-10 red-color">Continue Reading</a>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="primary-blog-box mb-60">
                                    <div class="blog-wrapper">
                                        <div class="row">
                                            <div class="col-xl-5 col-md-5">
                                                <div class="blog-box-img">
                                                    <a href="single-blog-1.html"><img src="img/blog/2.jpg" class="w-100" alt=""></a>
                                                    <div class="blog-box-tags">
                                                        <a href="single-blog-1.html">Image</a>
                                                        <a href="single-blog-1.html">Travel</a>
                                                    </div>
                                ...
                                <div class="primary-blog-box mb-60">
                                    <div class="blog-wrapper">
                                        <div class="row">
                                            <div class="col-xl-5 col-md-5">
                                                <div class="blog-box-img">
                                                    <a href="single-blog-1.html"><img src="img/blog/3.jpg" class="w-100" alt=""></a>
                                                    <div class="blog-box-tags">
                                                        <a href="single-blog-1.html">Image</a>
                                                        <a href="single-blog-1.html">Travel</a>
                                                    </div>
                                    ...
                                    <div class="blog-wrapper">
                                        <div class="row">
                                            ...
                                            <div class="col-xl-7 col-md-7">
                                                <div class="blog-box-desc primary-desc">
                                                    <div class="blog-box-link">
                                                        <h3><a href="single-blog-1.html">Quisque semper nunc vitae erat pell</a></h3>
                                                    </div>
                                                    <ul class="post-entry-data">
                                                        <li class="post-date">10 Jun, 2019</li>
                                                        <li class="post-by">Posted by <a href="javascript:void(0)" class="red-color f-400"><strong>admin</strong></a></li>
                    ...
                    <div class="col-xl-3 hidden-xl">
                        ...
                        <div class="widget blog-list pr-0">
                        ...
                        <div class="widget pr-0 mt-50">
                            <h4 class="mb-30">Recent Comments</h4>
                            <div class="post-box comment">
                                <ul>
                                    <li>
                                        <div class="post-img">
                                            <img src="img/small-img/1.jpg" class="w-100" alt="">
                                        </div>
                                        <div class="post-img-desc">
                                    ...
                                    <li>
                                        <div class="post-img">
                                            <img src="img/small-img/2.png" class="w-100" alt="">
                                        </div>
                                        <div class="post-img-desc">
                                            <a href="javascript:void(0)">admin</a>
                                            <p>Curabitur sagittis quam quis consectetur...</p>
