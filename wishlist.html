                ...
                <form action="#">
                    <div class="table-content table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    <td class="product-thumbnail"><a href="single-product-4.html"><img src="img/product/pro1.jpg"
                                                alt=""></a></td>
                                    <td class="product-name"><a href="single-product-4.html">Bakix Furniture</a></td>
                                ...
                                <tr>
                                    <td class="product-thumbnail"><a href="single-product-4.html"><img src="img/product/pro2.jpg"
                                                alt=""></a></td>
                                    <td class="product-name"><a href="single-product-4.html">Sujon Chair Set</a></td>
