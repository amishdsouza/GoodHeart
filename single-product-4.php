                                            ...
                                            <div class="tab-pane fade show active" id="tab-1">
                                                <div class="product-img">
                                                    <a class="popup-image" href="img/product/farniture-7.jpg"><img
                                                            src="img/product/farniture-7.jpg" class="w-100" alt=""></a>
                                                </div>
                                            </div>
                                            <div class="tab-pane fade" id="tab-2">
                                                <div class="product-img">
                                                    <a class="popup-image" href="img/product/farniture-8.jpg"><img
                                                            src="img/product/farniture-8.jpg" class="w-100" alt=""></a>
                                                </div>
                                            </div>
                                            <div class="tab-pane fade" id="tab-3">
                                                <div class="product-img">
                                                    <a class="popup-image" href="img/product/farniture-9.jpg"><img
                                                            src="img/product/farniture-9.jpg" class="w-100" alt=""></a>
                                                </div>
                                            </div>
                                            <div class="tab-pane fade" id="tab-4">
                                                <div class="product-img">
                                                    <a class="popup-image" href="img/product/farniture-10.jpg"><img
                                                            src="img/product/farniture-10.jpg" class="w-100" alt=""></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
