...
<body>
    ...
    <header class="header header-2 pt-30 pb-30 black-sticky header-sticky left-search">
        <div class="container-fluid">
            <div class="header-nav position-relative">
                <div class="row ">
                                ...
                                <div class="product-show-box">
                                    <div class="product-show-wrapper">
                                        <!-- <div class="loading-box">
                                                        <img src="img/logo/small-loading.gif" alt="">
                                                    </div> -->
                                        <div class="show-proudct-main">
                                            <ul>
                                                <li>
                                                    <div class="search-product-item">
                                                        ...
                                                        <div class="product-desc">
                                                            <a href="single-product-4.html" class="title">ELLE - Recliner syntheti deck
                                                                chair</a>
                                                            <span class="price red-color">$399.9</span>
                                                        </div>
                                                    </div>
                                                </li>
                                                <li>
                                            ...
                                            <div class="total-result text-center">
                                                55 result found
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="col-xl-6 col-lg-6 col-6 position-static">
                        <div class="header-nav">
                            <nav class="d-flex justify-content-between">
                                ...
                                <div class="logo">
                                    <a href="index4.html"><img src="img/logo/logo2.png" alt=""></a>
                                </div>
                                <ul class="white-content hidden-md ">
                    ...
                    <div class="col-xl-3 col-lg-2 col-6 col-md-6 col-sm-6 col-6">
                        <div class="header-right">
                            <ul class="text-right white-content">
                                <li><a href="registar.html" class="account"><i class="fal fa-user-friends"></i>
                                        <article class="account-registar d-inline-block text-white">Login/Sign up
                                        </article>
                                    </a></li>
                                                    ...
                                                    <ul class="text-left">
                                                        <li class="d-block d-flex align-items-center">
                                                            ...
                                                            <div class="search-result-desc pl-10">
                                                                <a href="single-product-5.html" class="title px-0">ELLE - Recliner syntheti
                                                                    chair</a>
                                                        ...
                                                        <li class="d-block d-flex align-items-center">
                                                            ...
                                                            <div class="search-result-desc pl-10">
                                                                <a href="single-product-5.html" class="title px-0">RIMINI - Folding leather
                                                                    deck chair</a>
                                                                <div class="price">$<span>399</span></div>
                                                            </div>
                                                        </li>
                                                        <li class="d-block d-flex align-items-center">
                                                            ...
                                                            <div class="search-result-desc pl-10">
                                                                <a href="single-product-5.html" class="title px-0">LANDSCAPE - Folding
                                                                    fabric deck chair</a>
                                                                <div class="price">$<span>399</span></div>
                                                            </div>
                                                        </li>
                                ...
                                <li class="d-xl-block"><a href="wishlist.html" data-toggle="tooltip" data-placement="bottom" title="view wishlist"><i
                                            class="fal fa-heart"><span>0</span></i></a></li>
                                                ...
                                                <ul class="text-left">
                                                    <li>
                                                        <div class="minicart-img">
                                                            <a href="single-product-5.html" class="p-0"><img src="img/product/1.jpg"
                                                                    class="w-100" alt=""></a>
                                                        </div>
                                                        <div class="minicart-desc">
                                                            <a href="single-product-5.html" class="p-0">Capitalize on low hanging fruit
                                                                t</a>
                                                    ...
                                                    <li>
                                                        <div class="minicart-img">
                                                            <a href="single-product-5.html" class="p-0"><img src="img/product/2.jpg"
                                                                    class="w-100" alt=""></a>
                                                        </div>
                                                        <div class="minicart-desc">
                                                    ...
                                                    <li>
                                                        <div class="minicart-img">
                                                            <a href="single-product-5.html" class="p-0"><img src="img/product/3.jpg"
                                                                    class="w-100" alt=""></a>
                                                        </div>
                                                        <div class="minicart-desc">
                                ...
                                <li><a href="javascript:void(0)"><i class="fal fa-align-right"></i></a>
                                    <ul class="submenu bold-content text-right">
                                        ...
                                        <li><a href="shop4.html">Shop</a></li>
    ...
    <section class="slider">
        <div class="slider-active center-dots number-dots white-dot">
            <div class="single-slider  h-950 d-flex align-items-center" data-background="img/slider/10.jpg">
                <div class="container">
                    <div class="single-slider-inner">
                        <div class="single-slider-content style-2 white-content text-left light-content">
                            <div class="slider-heading" data-animation="fadeInUp" data-delay=".4s" style="animation-delay: 0.4s;">
                                <p>Jack collection</p>
                                <h2 class="mb-0 strong-heading mt-10">HOODED</h2>
                            </div>
                            <div class="slider-desc" data-animation="fadeInUp" data-delay=".4s" style="animation-delay: 0.6s;">
                                <p class="mb-0 pl-0 mt-15">New Spring drops from Over. Shop the Collection</p>
                            </div>
                            <div class="slider-link slider-link-2 mt-75" data-animation="fadeInUp" data-delay=".4s" style="animation-delay: 0.8s;">
            ...
            <div class="single-slider  h-950 d-flex align-items-center" data-background="img/slider/11.jpg">
                <div class="container">
                    <div class="single-slider-inner">
                        <div class="single-slider-content style-2 white-content text-left light-content">
                            <div class="slider-heading"  data-animation="fadeInUp" data-delay=".4s" style="animation-delay: 0.4s;">
                            ...
                            <div class="slider-desc" data-animation="fadeInUp" data-delay=".4s" style="animation-delay: 0.4s;">
                                <p class="mb-0 pl-0 mt-15">New Spring drops from Over. Shop the Collection</p>
                            </div>
                            <div class="slider-link slider-link-2 mt-75" data-animation="fadeInUp" data-delay=".4s" style="animation-delay: 0.4s;">
                                <a href="shop4.html" class=" mt-70 text-uppercase" tabindex="0">Discover now</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="single-slider  h-950 d-flex align-items-center" data-background="img/slider/12.jpg">
                <div class="container">
                    <div class="single-slider-inner">
                        <div class="single-slider-content style-2 white-content text-left light-content">
                            <div class="slider-heading"  data-animation="fadeInUp" data-delay=".4s" style="animation-delay: 0.4s;">
            ...
            <div class="row justify-content-center">
                <div class="col-xl-4 col-md-6">
                    <div class="banner-img has-content body-banner">
                        <a href="shop4.html"><img src="img/banner/banner11.jpg" class="w-100" alt=""></a>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="banner-img has-content body-banner">
                        <a href="shop4.html"><img src="img/banner/banner12.jpg" class="w-100" alt=""></a>
                        <div class="banner-content">
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="banner-img has-content body-banner mb-0">
                        <a href="shop4.html"><img src="img/banner/banner13.jpg" class="w-100" alt=""></a>
                        <div class="banner-content">
                                ...
                                <div class="product-desc pb-20">
                                    <div class="product-desc-top">
                                        <div class="categories">
                                            <a href="shop4.html" class="product-category"><span>Woman</span></a>
                                        </div>
                                        <a href="wishlist.html" class="wishlist float-right"><span><i
                                                    class="fal fa-heart"></i></span></a>
                                    </div>
                                    <a href="single-product-5.html" class="product-title">Light green crewnec...</a>
                        ...
                        <div class="product-box mb-40">
                            <div class="product-box-wrapper">
                                ...
                                <div class="product-desc pb-20">
                                    ...
                                    <a href="single-product-5.html" class="product-title">Tassels Pendant Earrings</a>
                                    <div class="price-switcher">
                        ...
                        <div class="product-box mb-40">
                            <div class="product-box-wrapper">
                                ...
                                <div class="product-desc pb-20">
                                    <div class="product-desc-top">
                                        <div class="categories">
                                            <a href="shop4.html" class="product-category"><span>Shoes</span></a>
                                            <a href="shop4.html" class="product-category"><span>Sneaker</span></a>
                                            <a href="shop4.html" class="product-category"><span>Women</span></a>
                                        </div>
                                        <a href="wishlist.html" class="wishlist float-right"><span><i
                                                    class="fal fa-heart"></i></span></a>
                                    </div>
                                    <a href="single-product-5.html" class="product-title">Leather Courriere duffle bag</a>
                                    <div class="price-switcher">
                        ...
                        <div class="product-box mb-40">
                            <div class="product-box-wrapper">
                                ...
                                <div class="product-desc pb-20">
                                    ...
                                    <a href="single-product-5.html" class="product-title">Wood design bedroom clook</a>
                                    <div class="price-switcher">
                        ...
                        <div class="product-box mb-40">
                            <div class="product-box-wrapper">
                                ...
                                <div class="product-desc pb-20">
                                    ...
                                    <a href="single-product-5.html" class="product-title">Capitalize on low hanging fruit to</a>
                                    <div class="price-switcher">
                        ...
                        <div class="product-box mb-40">
                            <div class="product-box-wrapper">
                                ...
                                <div class="product-desc pb-20">
                                    <div class="product-desc-top">
                                        <div class="categories">
                                            <a href="shop4.html" class="product-category"><span>Handbag</span></a>
                                            <a href="shop4.html" class="product-category"><span>Handbag</span></a>
                                        </div>
                                        <a href="wishlist.html" class="wishlist float-right"><span><i
                                                    class="fal fa-heart"></i></span></a>
                                    </div>
                                    <a href="single-product-5.html" class="product-title">Coating design lighting lamp</a>
                                    <div class="price-switcher">
                ...
                <div class="col-xl-6 col-lg-6">
                    <div class="banner-img style-2 has-content body-banner">
                        ...
                        <div class="banner-content">
                            ...
                            <h3 class="mb-0">Accessories  for <br> women's</h3>
    ...
    <!-- banner-2 section end -->
            ...
            <section class="shipping-price-section pt-130 mt-120 gray-border-top">
                <div class="container">
                    ...
                    <div class="shipping-desc pt-35">
                        ...
                        <p class="mb-0">Donec vehicula cursus vestibulum lectus, sit eros integer varius cum turpis et quam congue nisl</p>
                        <p class="mb-0">accumsan ac bibendum ac in erat. Donec posuere consectetuer volutpat rutrum ac, sollicitudin quam quisque, at</p>
                        <p class="mb-0">interdum dignissim, fringilla elit risus lorem, eu condimentum eros mollis.</p>
                        <div class="text-center"><a href="shop4.html" class="generic-btn mt-50 red-hover-btn text-uppercase">Discover now</a></div>
                    </div>
                </div>
            </section>
            ...
            <section class="footer">
                <div class="footer-top mt-120 pb-120 pt-115 red-content" style="background-color: #EB2323;">
                    <div class="footer-top-wrapper">
                        <div class="newsletter ">
                            <div class="row">
                                <div class="col-xl-6 col-lg-6">
                                    <h2 class="title m-0 text-white">Sign Up For Our Newsletter</h2>
                                    <p class="text-white">Subscribe our newsletter and get discount 20% Off</p>
                                </div>
                                <div class="col-xl-6 col-lg-6">
                                    <div class="newsletter-form">
                                        <form action="#" method="POST">
                                            <input type="text" placeholder="Search for our newsletter...">
                                            <button type="submit" class="generic-btn red-hover-btn text-uppercase float-right">Subscribe Now</button>
                                        </form>
                                    </div>
                                </div>
                        ...
                        <!-- /.newsletter -->
                        <div class="service pt-57 mt-40 light-red-border-top">
                            <div class="row justify-content-center">
                                <div class="col-xl-4 col-md-6 service-item">
                                    <div class="service-box">
                                        <div class="service-box-content">
                                            <h4 class="title text-white">Worldwide Shipping</h4>
                                            <p class="service-desc text-white">Duis autem vel eum iriure dolor in hendrerit velit esse molestie consequat.</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-4 col-md-6 service-item">
                                    <div class="service-box">
                                        <div class="service-box-content">
                                            <h4 class="title text-white">Online Support 24/7</h4>
                                            <p class="service-desc text-white">Duis autem vel eum iriure dolor in hendrerit velit esse molestie consequat.</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-4 col-lg-6 hidden-md service-item">
                                    <div class="service-box">
                                        <div class="service-box-content">
                                            <h4 class="title text-white">Money Return Guarantee</h4>
                                            <p class="service-desc text-white">Duis autem vel eum iriure dolor in hendrerit velit esse molestie consequat.</p>
                                        </div>
                                    </div>
                                </div>
