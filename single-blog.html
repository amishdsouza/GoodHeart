                                ...
                                <div class="single-blog-box mt-10">
                                    <div class="blog-box-desc primary-desc">
                                        <div class="blog-box-link">
                                            <h3>Diam arcu, fringilla a sem condi cras</h3>
                                        </div>
                                        <ul class="post-entry-data">
                                            ...
                                            <div class="show-comment mt-50">
                                                <h3 class="show-comment-title">One comment on “Celebrating Female Leade ationa”</h3>
                                                <div class="row">
                                                    <div class="col-sm-2 col-3">
                                                        <div class="text-center">
                                                            <img src="img/logo/comment.png" alt="">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-10 col-9 pl-0">
                                                        <div class="show-comment-box">
                                                            <a href="javascript:void(0)" class="time">08 Apr, 2019 at 6:56 am</a>
                                                            <div class="author">
                                                                <h6>A WordPress Commenter<span>says</span></h6>
                                                            </div>
                                                            <div class="desc">
                                                                <p>Hi, this is a comment.
                                                                    ...
                                                                    <a href="javascript:void(0)" class="replay"><i class="fal fa-reply"></i> Replay</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="replay-box">
                                                ...
                                                <form action="#" method="POST">
                                                    <div class="form-group">
                                                        ...
                                                        <p class="help-block">You may use these HTML tags and attributes: <code>&lt;a href="" title=""&gt;</code> <code>&lt;abbr title=""&gt;</code> <code>&lt;acronym title=""&gt;</code> <code>&lt;b&gt;</code> <code>&lt;blockquote cite=""&gt;</code> <code>&lt;cite&gt;</code> <code>&lt;code&gt;</code> <code>&lt;del datetime=""&gt;</code> <code>&lt;em&gt;</code> <code>&lt;i&gt;</code> <code>&lt;q cite=""&gt;</code> <code>&lt;s&gt;</code> <code>&lt;strike&gt;</code> <code>&lt;strong&gt; </code></p></p>
                                                        <div class="form-group">
                                                            <div class="row">
                                                        ...
                                                        <button class="generic-btn red-hover-btn">Post Comment</button>
                                                    </div>
                                                </form>
                                            </div>
                                            <!-- /. replay box -->
