        ...
        <![endif]-->
            ...
            <div class="container pl-0 pr-0">
                    <div class="slider-active center-dots number-dots">
                        <div class="single-slider large-content h-790 d-flex align-items-center" data-background="img/slider/7.jpg">
                            <div class="container-fluid">
                                <div class="single-slider-inner">
                                    <div class="single-slider-content text-left light-content pl-10" style="text-align: left !important;">
                                        <div class="slider-heading small-heading-text" data-animation="flipInX" data-delay=".4s">
                                            <h2 class="mb-0">Sweater</h2>
                        ...
                        <div class="single-slider large-content h-790 d-flex align-items-center" data-background="img/slider/8.jpg">
                            <div class="container-fluid">
                                <div class="single-slider-inner">
                                    <div class="single-slider-content text-left light-content pl-10" style="text-align: left !important;">
                                        <div class="slider-heading small-heading-text" data-animation="flipInX" data-delay=".4s">
                                            <h2 class="mb-0">Minimalist</h2>
                                            <h2 class="mb-0">Unique Accessories</h2>
                                        </div>
                                        <div class="slider-desc" data-animation="flipInX" data-delay=".6s">
                                            <p class="mt-35 mb-0">New Spring drops from Over. Shop the Collection</p>
                                        </div>
                        ...
                        <div class="col-xl-4 col-md-6 service-item">
                            <div class="service-box service-box-3">
                                <div class="service-box-content text-center">
                                    ...
                                    <p class="service-desc">Duis autem vel eum iriure dolor in hendrerit vulputate
                                ...
                                <div class="product-box mb-40">
                                    <div class="product-box-wrapper">
                                        <div class="product-img">
                                            ...
                                            <a href="single-product-6.html" class="d-block"><div class="second-img">
                                        ...
                                        <div class="product-desc pb-20">
                                            ...
                                            <a href="single-product-6.html" class="product-title">Light green crewnec...</a>
                                ...
                                <div class="product-box mb-40">
                                    <div class="product-box-wrapper">
                                        ...
                                        <div class="product-desc pb-20">
                                            ...
                                            <a href="single-product-6.html" class="product-title">Leather Courriere duffle bag</a>
                                            <div class="price-switcher">
                                ...
                                <div class="product-box mb-40">
                                    <div class="product-box-wrapper">
                                        ...
                                        <div class="product-desc pb-20">
                                            ...
                                            <a href="single-product-6.html" class="product-title">Capitalize on low hanging fruit to</a>
                                            <div class="price-switcher">
                                ...
                                <div class="product-box mb-40">
                                    <div class="product-box-wrapper">
                                        ...
                                        <div class="product-desc pb-20">
                                            <div class="product-desc-top">
                                                <div class="categories">
                                                    <a href="shop.html"  class="product-category"><span>Handbag</span></a>
                                                    <a href="shop.html"  class="product-category"><span>Handbag</span></a>
                                                </div>
                                                <a href="wishlist.html" class="wishlist float-right"><span><i class="fal fa-heart"></i></span></a>
                                            </div>
                                            <a href="single-product-6.html" class="product-title">Coating design lighting lamp</a>
                                            <div class="price-switcher">
                    ...
                    <div class="blog-carousel owl-carousel pt-50">
                            ...
                            <div class="col-12">
                                <div class="blog-wrapper">
                                    <div class="blog-box-img">
                                        <a href="single-blog.htmlsingle-blog.html"><img src="img/blog/1.jpg" class="w-100" alt=""></a>
                        ...
                        <div class="blog-carousel-item">
                            <div class="col-12">
                                <div class="blog-wrapper">
                                    <div class="blog-box-img">
                                        <a href="single-blog.html"><img src="img/blog/2.jpg" class="w-100" alt=""></a>
                                        <div class="blog-box-tags">
                                            <a href="blog.html">Image</a>
                                            <a href="blog2.html">Travel</a>
                                        </div>
                        ...
                        <div class="blog-carousel-item">
                            <div class="col-12">
                                <div class="blog-wrapper">
                                    <div class="blog-box-img">
                                        <a href="single-blog.html"><img src="img/blog/3.jpg" class="w-100" alt=""></a>
                                        <div class="blog-box-tags">
                                            <a href="blog.html">Image</a>
                                            <a href="blog2.html">Travel</a>
                                        </div>
                ...
                <div class="footer-top footer-top-2 mt-110 pb-120 pt-115 gray-border-top">
                    <div class="footer-top-wrapper">
                        <div class="newsletter text-center row-content">
                            <div class="row">
                                <div class="col-12">
                                    <h2 class="title mb-20">Sign Up For Our Newsletter</h2>
                                    <p class="">Subscribe to the Mazia store mailing list to receive updates on new arrivals, special offers and<br>
                                ...
                                <div class="col-12">
                                    <div class="newsletter-form">
                                        <form action="#" method="POST">
                                            ...
                                            <button type="submit" class="generic-btn text-center red-hover-btn text-uppercase">Subscribe Now</button>
                                        </form>
                                    </div>
                                </div>
