                    ...
                    <div class="col-xl-4 col-lg-3 col-6 col-md-6 col-sm-6 col-9">
                        <div class="header-right">
                            <ul class="text-right">
                                                ...
                                                <div class="search-result-list">
                                                    <ul class="text-left">
                                                        ...
                                                        <li class="d-block d-flex align-items-center">
                                                            ...
                                                            <div class="search-result-desc pl-10">
                                                                <a href="single-product-4.html"
                                                                    class="title px-0">RIMINI - Folding leather deck
                                                                    chair</a>
                                                                <div class="price">$<span>399</span></div>
                                                            </div>
                                                        </li>
                                                        <li class="d-block d-flex align-items-center">
                                                            ...
                                                            <div class="search-result-desc pl-10">
                                                                <a href="single-product-4.html"
                                                                    class="title px-0">LANDSCAPE - Folding fabric deck
                                                                    chair</a>
                                                                <div class="price">$<span>399</span></div>
                                                            </div>
                                                        </li>
                                ...
                                <li><a href="wishlist.html" data-toggle="tooltip" data-placement="bottom" title=""
                                                ...
                                                <ul class="text-left">
                                                    <li>
                                                        <div class="minicart-img">
                                                            <a href="single-product-4.html" class="p-0"><img
                                                                    src="img/product/1.jpg" class="w-100" alt=""></a>
                                                        </div>
                                                        <div class="minicart-desc">
                                                            <a href="single-product-4.html" class="p-0">Capitalize on
                                                    ...
                                                    <li>
                                                        ...
                                                        <div class="minicart-desc">
                                                            <a href="single-product-4.html" class="p-0">Party Supplies
                                                                Around Cupcake</a>
                                                            <strong>1 × $150.00</strong>
                                                        </div>
                                                        <div class="remove">
                    ...
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-4 col-12">
                            <div class="shop-img">
                                <div class="row">
                                    <div class="col-md-6">
                                        <a href="img/product/farniture-1.jpg" class="popup-image"><img
                                                src="img/product/farniture-1.jpg" class="w-100 mb-30" alt=""></a>
                                    </div>
                                    <div class="col-md-6">
                                        <a href="img/product/farniture-2.jpg" class="popup-image"><img
                                                src="img/product/farniture-2.jpg" class="w-100 mb-30" alt=""></a>
                                    </div>
                                    <div class="col-md-6">
                                        <a href="img/product/farniture-3.jpg" class="popup-image"><img
                                                src="img/product/farniture-3.jpg" class="w-100 mb-30" alt=""></a>
                                    </div>
                                    <div class="col-md-6">
                                        <a href="img/product/farniture-4.jpg" class="popup-image"><img
                                                src="img/product/farniture-4.jpg" class="w-100 mb-30" alt=""></a>
                                    </div>
                                    <div class="col-md-6">
                                        <a href="img/product/farniture-5.jpg" class="popup-image"><img
                                                src="img/product/farniture-5.jpg" class="w-100 mb-30" alt=""></a>
                                    </div>
                                    <div class="col-md-6">
                                        <a href="img/product/farniture-6.jpg" class="popup-image"><img
                                                src="img/product/farniture-6.jpg" class="w-100" alt=""></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="single-product-sidebar">
                                <div class="product-content">
                                    ...
                                    <div class="quick-quantity mt-10">
                                        <form action="#" method="POST">
                                            <div class="total-cart"><span class="cart-count">19 in stock (can be
                                    ...
                                    <div class="single-product-action mt-35">
                                        <ul>
                                            ...
                                            <li><a href="single-product-4.html"><i class="fal fa-abacus"></i> add to
                                                    compare</a></li>
                                        </ul>
                                    </div>
                                    ...
                                    <div class="single-product-category">
                                        <ul>
                                            ...
                                            <li class="mb-0"><a href="shop3.html">Chair &amp; Table</a></li>
                                            <li class="mb-0"><a href="shop3.html">Chairs</a></li>
                                            <li class="mb-0"><a href="shop3.html">Handbeg</a></li>
                                        </ul>
                                    </div>
                                    <div class="single-product-tags">
                                        <ul>
                                            <li><a href="javascript:void(0)" class="title" style="color: #888;">Tags:
                                                </a></li>
