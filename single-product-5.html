                                        ...
                                        <div class="tab-content" id="v-pills-tabContent">
                                            <div class="tab-pane fade show active" id="tab-1">
                                                <div class="product-img">
                                                    <a href="img/product/farniture-7.jpg" class="popup-image" ><img src="img/product/farniture-7.jpg" class="w-100" alt=""></a>
                                                </div>
                                            </div>
                                            <div class="tab-pane fade" id="tab-2">
                                                <div class="product-img">
                                                    <a href="img/product/farniture-8.jpg" class="popup-image" ><img src="img/product/farniture-8.jpg" class="w-100" alt=""></a>
                                                </div>
                                            </div>
                                                <div class="tab-pane fade" id="tab-3">
                                                    <div class="product-img">
                                                        <a href="img/product/farniture-9.jpg" class="popup-image" ><img src="img/product/farniture-9.jpg" class="w-100" alt=""></a>
                                                    </div>
                                                </div>
                                                <div class="tab-pane fade" id="tab-4">
                                                    <div class="product-img">
                                                        <a href="img/product/farniture-10.jpg" class="popup-image" ><img src="img/product/farniture-10.jpg" class="w-100" alt=""></a>
                                                    </div>
                                                </div>
                                          </div>
                                    </div>
                                    <div class="col-2">
                                        <div class="nav nav-pills has-border-img" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                            ...
                                            <a data-toggle="pill" href="#tab-2">
                                                <img src="img/product/farniture-8.jpg" class="w-100 mt-5-px" alt="">
                                            </a>
                                            <a data-toggle="pill" href="#tab-3">
                                                <img src="img/product/farniture-9.jpg" class="w-100 mt-5-px" alt="">
                                            </a>
                                            <a data-toggle="pill" href="#tab-4">
                                                <img src="img/product/farniture-10.jpg" class="w-100 mt-5-px" alt="">
                                            </a>
                                          </div>
                                    </div>
                                </div>
                                ...
                                <div class="product-content">
                                    ...
                                    <div class="single-product-action mt-35">
                                        <ul>
                                            ...
                                            <li><a href="single-product-5.html"><i class="fal fa-abacus"></i> add to compare</a></li>
                                        </ul>
                                    </div>
                                    ...
                                    <div class="single-product-category">
                                        <ul>
                                            ...
                                            <li class="mb-0"><a href="single-product-4.html">Chair &amp; Table</a></li>
                                            <li class="mb-0"><a href="single-product-4.html">Chairs</a></li>
                                            <li class="mb-0"><a href="single-product-4.html">Handbeg</a></li>
                                        </ul>
                                    </div>
