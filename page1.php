...
<body>
                                                    ...
                                                    <ul class="text-left">
                                                        <li class="d-block d-flex align-items-center">
                                                            ...
                                                            <div class="search-result-desc pl-10">
                                                                <a href="single-product-6.html" class="title px-0">ELLE - Recliner syntheti
                                                                    chair</a>
                                                        ...
                                                        <li class="d-block d-flex align-items-center">
                                                            ...
                                                            <div class="search-result-desc pl-10">
                                                                <a href="single-product-6.html" class="title px-0">RIMINI - Folding leather
                                                                    deck chair</a>
                                                                <div class="price">$<span>399</span></div>
                                                            </div>
                                                        </li>
                                                        <li class="d-block d-flex align-items-center">
                                                            ...
                                                            <div class="search-result-desc pl-10">
                                                                <a href="single-product-6.html" class="title px-0">LANDSCAPE - Folding
                                                                    fabric deck chair</a>
                                                                <div class="price">$<span>399</span></div>
                                                            </div>
                                                        </li>
                                                ...
                                                <ul class="text-left">
                                                    <li>
                                                        <div class="minicart-img">
                                                            <a href="single-product-6.html" class="p-0"><img src="img/product/1.jpg"
                                                                    class="w-100" alt=""></a>
                                                        </div>
                                                        <div class="minicart-desc">
                                                            <a href="single-product-6.html" class="p-0">Capitalize on low hanging fruit
                                                                t</a>
                                                    ...
                                                    <li>
                                                        <div class="minicart-img">
                                                            <a href="single-product-6.html" class="p-0"><img src="img/product/2.jpg"
                                                                    class="w-100" alt=""></a>
                                                        </div>
                                                        <div class="minicart-desc">
                                                            <a href="single-product-6.html" class="p-0">Leather Courriere duffle ba</a>
                                                    ...
                                                    <li>
                                                        <div class="minicart-img">
                                                            <a href="single-product-6.html" class="p-0"><img src="img/product/3.jpg"
                                                                    class="w-100" alt=""></a>
                                                        </div>
                                                        <div class="minicart-desc">
                                                            <a href="single-product-6.html" class="p-0">Party Supplies Around Cupcake</a>
                                                            <strong>1 × $150.00</strong>
                                                        </div>
                                                        <div class="remove">
                                                            <i class="fal fa-times"></i>
    ...
    <section class="slider">
        <div class="slider-active">
            <div class="single-slider  h-950  d-flex align-items-center" data-background="img/slider/4.jpg">
                <div class="container">
                    <div class="single-slider-inner">
                        <div class="single-slider-content text-left light-content">
                            <div class="slider-heading " data-animation="fadeInUp" data-delay=".4s">
                                <h2 class="mb-0 strong-heading">LOOKBOOK</h2>
                            </div>
                            <div class="slider-desc slider-desc-2" data-animation="fadeInUp" data-delay=".6s">
                            ...
                            <div class="slider-link" data-animation="fadeInUp" data-delay=".8s">
                                <a href="shop.html" class="generic-btn mt-70 red-hover-btn text-uppercase">Discover
                                    now</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="single-slider  h-950  d-flex align-items-center" data-background="img/slider/5.jpg">
                <div class="container">
                    <div class="single-slider-inner">
                        <div class="single-slider-content text-left light-content">
                            <div class="slider-heading " data-animation="fadeInUp" data-delay=".4s">
                                <h2 class="mb-0 strong-heading">OVER.S18</h2>
                            </div>
                            <div class="slider-desc slider-desc-2" data-animation="fadeInUp" data-delay=".6s">
                                <p class="mt-35 mb-0">New Spring drops from Over. Shop the Collection</p>
                            </div>
            ...
            <div class="single-slider  h-950  d-flex align-items-center" data-background="img/slider/6.jpg">
                <div class="container">
                    <div class="single-slider-inner">
                        <div class="single-slider-content text-left light-content">
                            <div class="slider-heading " data-animation="fadeInUp" data-delay=".4s">
                                <h2 class="mb-0 strong-heading" data-animation="animated animate__jello"
                                    data-delay=".5s">Style. S16</h2>
                            </div>
                            <div class="slider-desc slider-desc-2" data-animation="fadeInUp" data-delay=".6s">
                                <p class="mt-35 mb-0">New Spring drops from Over. Shop the Collection</p>
                            </div>
    ...
    <!-- stylish collection section start -->
    <section class="stylish-collection mt-120">
        <div class="container container-1200">
            <div class="generic-title text-center">
                <h2 class="mb-20">New & Stylish Collections</h2>
                ...
                <p>est usus legentis in iis qui facit eorum claritatem.</p>
            </div>
            <div class="home-widget mt-80">
                <div class="home-widget-inner">
                    <div class="row align-items-center">
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                            <div class="widget-content">
                                <h3>Mazia Clothing Collections For Woman’s 2019</h3>
                                <p class="mt-20 mb-35">Typi non habent claritatem insitam est usus legentis in iis qui
                                    facit eorum claritatem, quod mazim placerat facer possim assum.</p>
                                <a href="shop.html" class="home-widget-link text-uppercase">Discover now</a>
                            </div>
                        </div>
                        <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12">
                            <div class="home-widget-right">
                                <div class="row">
                                    <div
                                        class="col-xl-6  col-lg-6 col-md-6 col-sm-6 d-flex justify-content-center align-items-center">
                                        <div class="widget-sm-img">
                                            <a href="shop.html">
                                                <div class="banner-img">
                                                    <img src="img/banner/w-sm-1.jpg" class="w-100" alt="">
                                                </div>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                        <div class="widgt-big-img">
                                            <a href="shop.html">
                                                <div class="banner-img">
                                                    <img src="img/banner/w-big-1.jpg" class="w-100s" alt="">
                                                </div>
                                            </a>
                                        </div>
                                    </div>
                ...
                <div class="home-widget-inner">
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12">
                            <div class="widgt-big-img">
                                <a href="shop.html">
                                    <div class="banner-img has-mega-img">
                                        <img src="img/banner/w-big-2.jpg" class="w-100s" alt="">
                                    </div>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                            <div class="widget-content text-right">
                                <h3>Top Sneaker Collections For Man’s</h3>
                                <p class="mt-20 mb-35">Typi non habent claritatem insitam est usus legentis in iis qui
                                    facit eorum claritatem, quod mazim placerat facer possim assum.</p>
                                <a href="shop.html" class="home-widget-link text-uppercase">Discover now</a>
                            </div>
                                ...
                                <div class="row">
                                    <div
                                        ...
                                        <div class="widget-sm-img">
                                            <a href="shop.html">
                                                <div class="banner-img">
                                                    <img src="img/banner/w-sm-3.jpg" class="w-100s" alt="">
                                                </div>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                        <div class="widgt-big-img">
                                            <a href="shop.html">
                                                <div class="banner-img">
                                                    <img src="img/banner/w-big-3.png" class="w-100s" alt="">
                                                </div>
                                            </a>
                                        </div>
                                    </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12">
                            <div class="widgt-big-img">
                                <a href="shop.html">
                                    <div class="banner-img has-mega-img">
                                        <img src="img/banner/w-big-4.jpg" class="w-100s" alt="">
                                    </div>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                            <div class="widget-content text-right">
                                <h3>Accessories Collections Big Sale Limited</h3>
                                <p class="mt-20 mb-35">Typi non habent claritatem insitam est usus legentis in iis qui
                                    facit eorum claritatem, quod mazim placerat facer possim assum.</p>
                                <a href="shop.html" class="home-widget-link text-uppercase">Discover now</a>
                            </div>
    ...
    <!-- stylish collection section end -->
    ...
    <section class="new-arrival mt-120">
        <div class="container container-1200">
            ...
            <div class="new-arrival-carousel owl-carousel red-nav mt-50">
                <div class="carousel-single-item">
                    <div class="col-12">
                        <div class="product-box">
                            <div class="product-box-wrapper">
                                <div class="product-img">
                                    <img src="img/product/5.jpg" class="w-100s" alt="">
                                    <a href="single-product-6.html" class="d-block">
                                        <div class="second-img">
                                            <img src="img/product/5-hover.jpg" alt="" class="w-100s">
                                        </div>
                                    </a>
                                ...
                                <div class="product-desc pb-20">
                                    <div class="product-desc-top">
                                        <div class="categories">
                                            <a href="shop.html" class="product-category"><span>Woman</span></a>
                                        </div>
                                        <a href="wishlist.html" class="wishlist float-right"><span><i
                                                    class="fal fa-heart"></i></span></a>
                                    </div>
                                    <a href="single-product-6.html" class="product-title">Light green crewneck
                                        sweatshir</a>
                        ...
                        <div class="product-box">
                            <div class="product-box-wrapper">
                                ...
                                <div class="product-desc pb-20">
                                    ...
                                    <a href="single-product-6.html" class="product-title">Tassels Pendant Earrings</a>
                                    <div class="price-switcher">
                        ...
                        <div class="product-box mb-40">
                            <div class="product-box-wrapper">
                                ...
                                <div class="product-desc pb-20">
                                    <div class="product-desc-top">
                                        <div class="categories">
                                            <a href="shop.html" class="product-category"><span>Shoes</span></a>
                                            <a href="shop.html" class="product-category"><span>Sneaker</span></a>
                                            <a href="shop.html" class="product-category"><span>Women</span></a>
                                        </div>
                                        <a href="wishlist.html" class="wishlist float-right"><span><i
                                                    class="fal fa-heart"></i></span></a>
                                    </div>
                                    <a href="single-product-6.html" class="product-title">Leather Courriere duffle
                                        bag</a>
                                    <div class="price-switcher">
                        ...
                        <div class="product-box mb-40">
                            <div class="product-box-wrapper">
                                ...
                                <div class="product-desc pb-20">
                                    ...
                                    <a href="single-product-6.html" class="product-title">Wood design bedroom clook</a>
                                    <div class="price-switcher">
                        ...
                        <div class="product-box mb-40">
                            <div class="product-box-wrapper">
                                ...
                                <div class="product-desc pb-20">
                                    ...
                                    <a href="single-product-6.html" class="product-title">Capitalize on low hanging
                                        fruit to</a>
                                    <div class="price-switcher">
    ...
    <section class="shipping-price-section pt-130 mt-60 gray-border-top">
        <div class="container">
            ...
            <div class="shipping-desc pt-35">
                ...
                <div class="text-center"><a href="shop.html" class="generic-btn mt-50 red-hover-btn text-uppercase">Discover
                        now</a></div>
            </div>
        </div>
    </section>
    ...
    <section class="footer">
        <div class="footer-top  footer-top-2  mt-120 pb-120 pt-115 red-content" style="background-color: #EB2323;">
                        ...
                        <div class="col-xl-4 col-md-6 service-item">
                            <div class="service-box">
                                <div class="service-box-content">
                                    ...
                                    <p class="service-desc text-white">Duis autem vel eum iriure dolor in hendrerit
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-7 col-lg-7 col-md-7 col-sm-6">
                            <div class="product-content">
                                ...
                                <a href="single-product-6.html" class="all-feature">See all feature</a>
