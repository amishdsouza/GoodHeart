                                    ...
                                    <ul>
                                        ...
                                        <li class="position-static">
                                            <a href="javascript:void(0)">
                                                <span>Shop  <i class="fal fa-angle-down"></i></span>
                                            </a>
                                ...
                                <ul class="text-right">
                                    <li>
                                        <a href="register.php" class="account">
                                            ...
                                            <article class="account-registar d-inline-block">Sign up</article>
                                        </a>
                                    </li>
                                    ...
                                    <li>
                                        <a href="wishlist.php" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="view wishlist">
