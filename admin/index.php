...
<html lang="en">
  ...
  <body class="goto-here">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="index.html">Gricee Grocery</a>
        ...
        <div class="container-admin">
          <div class="row justify-content-end">
            ...
            <div class="col-md-6-admin heading-section ftco-animate deal-of-the-day ftco-animate">
              <h2 class="mb-4" id="admin">ADMIN</h2>
                <div class="wrap-inputemail" id="wrap-input">
                  <input class="inputemail" type="email" name="email" id="email" placeholder="Email" required>
                  <input class="inputemail" type="password" name="password" id="password" placeholder="Password" required>
                    <button type="submit" name="login" class="login100-form-btn"><b>LOGIN</b></button>
                </div>
            </div>
          </div>
        </div>
        ...
        <div class="row mb-5">
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              <h2 class="ftco-heading-2">Gricee Grcoery</h2>
