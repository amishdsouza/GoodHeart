...
<table class="table table-hover table-dark">
          <?php
            if(mysqli_num_rows($res_data)==0)
            {
              ...
              echo "<thead>";
              echo "<tr>";
              echo "<th><span class=\"tb-text\">Category ID</span></th>";
              echo "<th><span class=\"tb-text\">Category Name</span></th>";
              echo "<th><span class=\"tb-text\">Category Image</span></th>";
              echo "</tr>";
              echo "</thead>";
              ...
              while ($data = mysqli_fetch_array($res_data)) {
                ...
                echo "<tr>";
                echo "<th><span class=\"tb-text\">".$data['Category_ID']."</span></th>";
                echo "<th><span class=\"tb-text\">".$data['Category_Name']."</span></th>";
                echo "<th><img src=\"data:image;base64,".$data['Category_Image_Temp']."\" alt=".$data['Category_Image_Name']." width=\"150px\" height=\"150px\"></th>";
                echo "</tr>";
              }
                echo "</tbody>";
            }
